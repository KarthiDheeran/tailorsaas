-- Capture verbal delivery commitments without turning orders into a generic
-- notes dump. This is the customer-facing promise/context around the due date.

alter table orders
  add column if not exists delivery_promise_note text not null default '';

        ...
        >
          <div className="space-y-5 px-6 py-5">
            ...
            <div className="min-w-0 rounded-xl border border-border-soft bg-white p-4 shadow-soft">
              <div className="flex flex-col gap-4">
                ...
                <div className="min-w-0 rounded-lg border border-border-soft bg-surface-muted p-3">
          ...
          <div className="flex items-center gap-2 border-t border-border-soft px-6 py-4">
            <button
              type="submit"
              disabled={submitting}
              className="flex-1 rounded-lg bg-secondary px-4 py-2.5 text-sm font-semibold text-white shadow-soft transition-colors hover:bg-secondary-hover disabled:opacity-60"
            >
              {submitting
                ? "Saving…"
                : isEdit
